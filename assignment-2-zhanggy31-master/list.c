...
/* ptr_null is used to check the list->head point to NULL or not*/
...
/*rmv4pop is used to pop and remove the data in the stack*/
...
/*top is used to get the toppest value in the stack*/
